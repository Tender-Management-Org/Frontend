...
> = {
  ...
  warning: {
    ...
    icon: "bg-warning-50 dark:bg-warning-500/10 text-warning-600 dark:text-warning-400",
    subtitle: "text-warning-600 dark:text-warning-400",
    border: "border-l-warning-400",
  },
  danger: {
    value: "text-danger-600 dark:text-danger-400",
    icon: "bg-danger-50 dark:bg-danger-500/10 text-danger-600 dark:text-danger-400",
    subtitle: "text-danger-600 dark:text-danger-400",
    border: "border-l-danger-500",
  },
  success: {
    value: "text-success-700 dark:text-success-400",
    icon: "bg-success-50 dark:bg-success-500/10 text-success-700 dark:text-success-400",
    subtitle: "text-success-700 dark:text-success-400",
